...
{   //declaration de  varaible gtk
    ...
    title1 = gtk_label_new("********le résultat généré avec socket TCP********");
    ...
    gtk_window_set_title(GTK_WINDOW(window), "Résultat TCP Window");
